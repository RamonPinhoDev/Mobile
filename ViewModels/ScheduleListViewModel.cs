...
namespace ScheduleListUI.ViewModels
{
    public partial class ScheduleListViewModel : ObservableObject
    {
        ...
        private void GetWeekDaysInfo()
        {
            ...
            // Inicia a semana na segunda-feira
            DateTime startDayOfWeek = CurrentDate.AddDays(-(int)CurrentDate.DayOfWeek + 1);

            // Se o dia atual for domingo (DayOfWeek == 0), subtrai 6 dias para começar na segunda-feira anterior
            if (CurrentDate.DayOfWeek == DayOfWeek.Sunday)
            {
                startDayOfWeek = CurrentDate.AddDays(-6);
            }
